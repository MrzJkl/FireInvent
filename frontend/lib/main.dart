...
import 'package:flameguardlaundry/services/auth_service.dart';
...
void main() {
  ...
  GetIt.I.registerLazySingleton<ClothingAssignmentService>(
      ...
      GetIt.I.registerLazySingleton<DepartmentService>(
      () => DepartmentService());
      GetIt.I.registerLazySingleton<MaintenanceService>(
      () => MaintenanceService());
      GetIt.I.registerLazySingleton<PersonService>(
      () => PersonService());
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ClothingProductListScreen(),
    );
  }
}
