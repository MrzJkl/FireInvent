...
public class ClothingItemAssignmentHistoryServiceTest
{
    ...
    private static ClothingItem CreateItem(AppDbContext context)
    {
        ...
        var item = new ClothingItem
        {
            ...
            Identifier = "ITEM-001",
            Condition = Contract.GearCondition.New,
    ...
    public async Task CreateAssignmentAsync_ShouldCreateAssignment()
    {
        ...
        var model = new CreateClothingItemAssignmentHistoryModel
        {
            ItemId = item.Id,
            PersonId = person.Id,
    ...
    public async Task CreateAssignmentAsync_ShouldThrowIfOverlappingAssignmentExists()
    {
        ...
        var item = CreateItem(context);
        var person = CreatePerson(context);
        context.ClothingItemAssignmentHistories.Add(new ClothingItemAssignmentHistory
        {
            Id = Guid.NewGuid(),
            ItemId = item.Id,
            PersonId = person.Id,
    ...
    public async Task GetAssignmentsForItemAsync_ShouldReturnAssignments()
    {
        ...
        var item = CreateItem(context);
        var person = CreatePerson(context);
        var assignment1 = new ClothingItemAssignmentHistory
        {
            Id = Guid.NewGuid(),
            ItemId = item.Id,
            PersonId = person.Id,
        ...
        var assignment2 = new ClothingItemAssignmentHistory
        {
            Id = Guid.NewGuid(),
            ItemId = item.Id,
            PersonId = person.Id,
    ...
    public async Task GetAssignmentByIdAsync_ShouldReturnAssignment()
    {
        ...
        var item = CreateItem(context);
        var person = CreatePerson(context);
        var assignment = new ClothingItemAssignmentHistory
        {
            Id = Guid.NewGuid(),
            ItemId = item.Id,
            PersonId = person.Id,
    ...
    public async Task UpdateAssignmentAsync_ShouldUpdateAssignment()
    {
        ...
        var model = new ClothingItemAssignmentHistoryModel
        {
            Id = assignment.Id,
            ItemId = item.Id,
            PersonId = person.Id,
