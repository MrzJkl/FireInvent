...
public class ClothingItemAssignmentHistoryService(AppDbContext context, IMapper mapper) : IClothingItemAssignmentHistoryService
{
    public async Task<ItemAssignmentHistoryModel> CreateAssignmentAsync(CreateItemAssignmentHistoryModel model)
    {
        ...
        var entity = mapper.Map<ItemAssignmentHistory>(model);
        entity.Id = Guid.NewGuid();

        context.ClothingItemAssignmentHistories.Add(entity);
        await context.SaveChangesAsync();

        return mapper.Map<ItemAssignmentHistoryModel>(entity);
    }
    ...
    public async Task<List<ItemAssignmentHistoryModel>> GetAssignmentsForItemAsync(Guid itemId)
    {
        ...
        return mapper.Map<List<ItemAssignmentHistoryModel>>(entities);
    }
    ...
    public async Task<ItemAssignmentHistoryModel?> GetAssignmentByIdAsync(Guid id)
    {
        ...
        return entity is null ? null : mapper.Map<ItemAssignmentHistoryModel>(entity);
    }
