...
namespace FlameGuardLaundry.Database.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ClothingItemAssignmentHistory",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClothingItemAssignmentHistory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClothingItemAssignmentHistory_ClothingItems_ItemId",
                        column: x => x.ItemId,
                        principalTable: "ClothingItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClothingItemAssignmentHistory_Persons_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ItemId = table.Column<Guid>(type: "uuid", nullable: false),
                    Performed = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClothingItemAssignmentHistory_ItemId_AssignedFrom",
                table: "ClothingItemAssignmentHistory",
                columns: new[] { "ItemId", "AssignedFrom" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClothingItemAssignmentHistory_PersonId",
                table: "ClothingItemAssignmentHistory",
                column: "PersonId");
